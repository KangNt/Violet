...
<html class="no-js" lang="zxx">
    <head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="./assets/img/logo-S.png">
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="./assets/img/logo/logo-SB.png" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-2">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="./assets/img/logo/logo-SB.png" class="col-md-10" alt="">
                                </a>
                            </div>
                        </div>
    ...
    <main>
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".4s">Web Administrator</span>
                                    <h1 data-animation="fadeInUp" data-delay=".6s">Scan QR Code<br>with SmartBuy</h1>
                                    <p data-animation="fadeInUp" data-delay=".8s">SmartBuy ứng dụng mua sắm thông minh </p>
                                    <!-- Slider btn -->
                            ...
                            <div class="col-lg-6">
                                <div class="hero__img d-none d-lg-block f-right" data-animation="fadeInRight" data-delay="1s">
                                    <img src="./assets/img/hero/content.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-slider slider-height slider-padding sky-blue d-flex align-items-center">
                    <div class="container">
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".4s">Introduce SmartBuy</span>
                                    <h1 data-animation="fadeInUp" data-delay=".6s">Get things done<br>with SmartBuy</h1>
                                    <p data-animation="fadeInUp" data-delay=".8s"> Giải pháp tem xác thực điện tử
                            ...
                            <div class="col-lg-6">
                                <div class="hero__img d-none d-lg-block f-right" data-animation="fadeInRight" data-delay="1s">
                                    <img src="./assets/img/hero/slide-wraper.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="best-features-area section-padd4">
            ...
            <div class="features-shpae d-none d-lg-block">
                <img src="./assets/img/hero/silde-wraper.png" alt="">
            </div>
        </section>
        <!-- Best Features End -->
        <!-- Services Area Start -->
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6">
                        <div class="section-tittle text-center">
                            <h2>How Can We HelpYour<br>with SmartBuy!</h2>
                        </div>
                    </div>
                </div>
                <!-- Section caption -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-8">
                        <div class="single-cases-info mb-30">
                            <h3>SmartBuy Apps<br> Screenshot</h3>
                            <p>
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-col-md-7">
                        <div class="app-active owl-carousel"> 
                            <div class="single-cases-img">
                                <img src="./assets/img/gallery/slide-wraper.png" alt="">
                            </div>
                            <div class="single-cases-img">
                                <img src="./assets/img/gallery/content.png" alt="">
                            </div>
                            <div class="single-cases-img">
                                <img src="./assets/img/gallery/slide-wraper.png" alt="">
                            </div>
            ...
            <div class="container">
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="app-img">
                            <img src="./assets/img/shape/hero_right.png" alt="">
                        </div>
                    </div>
                </div>./
            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-8">
                         <div class="single-footer-caption mb-30">
                             ...
                             <div class="footer-logo">
                                 <a href="index.html"><img src="assets/img/logo/logo-SB.png" alt=""></a>
                             </div>
