            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="header-item">
                        <img src="site/img/icons/delivery.png" alt="">
                        <p>Free shipping on orders over $30 in USA</p>
                    </div>
                </div>
                <div class="col-md-4 text-left text-lg-center">
                    <div class="header-item">
                        <img src="site/img/icons/voucher.png" alt="">
                        <p>20% Student Discount</p>
                    </div>
                </div>
                <div class="col-md-4 text-left text-xl-right">
                    <div class="header-item">
                    <img src="site/img/icons/sales.png" alt="">
                    ...
                    <div class="col-lg-12">
                        <div class="payment-method">
                            ...
                            <ul>
                                ...
                                <li>Credit / Debit card <img src="site/img/mastercard.jpg" alt=""></li>
                                <li>
